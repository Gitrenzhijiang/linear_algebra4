        ...
        <div class="main-page">
            ...
            <div class="grids">
                ...
                <div class="panel panel-widget">
                    <div class="row">
                        <label class="col-md-2">矩阵阶数:</label>
                        <div class="col-md-8">
                    ...
                    <hr/>
                    <well>矩阵相似:</well><well class="value"></well>
                </div>
            </div>
            <!--//grids-->
...
var fun = function(){
	   	...
	   	var arr1 = [];
		   var item1 = $('input', fz1obj);
	    for(var i = 0;i < item1.length;i++){
	        var txt = $(item1.get(i)).val();
	       	arr1[i] = txt;
	     }
	    var arr2 = [];
		   var item2 = $('input', fz2obj);
	    ...
	    ajax(
				{
					url:"<c:url value='/ojs.action!jzxs'/>",
					type:"text",
					method:"post",
					params:"arr1=" + arr1 +"&arr2=" + arr2+ "&row=" + rowobj.val(),
    ...
    rowobj.change(function(){
    	changetable(fz1obj, rowobj.val(), rowobj.val());
    	changetable(fz2obj, rowobj.val(), rowobj.val());
    	$('input', fz1obj).change(fun);
    	$('input', fz2obj).change(fun);
    });
    $('input', fz1obj).change(fun);
	$('input', fz2obj).change(fun);
</script>
