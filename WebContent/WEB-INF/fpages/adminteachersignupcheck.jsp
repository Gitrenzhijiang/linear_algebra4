                        ...
                        <div class="panel panel-widget">
                            <div class="compose-left">
                                <div class="folder widget-shadow">
                                    <ul>
                                        <li class="head">分类</li>
                                        <li><a href="<c:url value='/user.action!tosignupcheck'/>"><i class="fa fa-inbox"></i>未通过</a></li>
                                        <li><a href="<c:url value='/user.action!tosignupcheck?tg=1'/>"><i class="fa fa fa-check"></i>已通过</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-widget">
                            <div class="inbox-page">
                                ...
                                <div class="inbox-row widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="mail"><img src="${user.headpic }" alt=""></div>
                                    <div class="mail mail-name"> <h6>${user.user_no }&nbsp;${user.name }</h6> </div>
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne${user.pk_id }" aria-expanded="true" aria-controls="collapseOne${user.pk_id }">
                                        <div class="mail"><p>${user.email }</p></div>
                                    </a>
                                    <div class="mail-right">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu float-right">
                                            	<c:if test="${user.activation eq 11}">
                                                <li>
                                                    <a role="button" href="<c:url value='/user.action!signupcheck?user_id=${user.pk_id }'/>">
                                                ...
                                                <li>
                                                    <a href="<c:url value='/user.action!signupdelete?user_id=${user.pk_id }'/>" class="font-red" title="">
                                    ...
                                    <div class="mail-right"><p>
                                    	
                                    </p></div>
                                    <div class="clearfix"> </div>
                                    <div id="collapseOne${user.pk_id }" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="mail-body">
                                            <p>${user.descript }</p>
											<p>申请时间:<fmt:formatDate value="${user.ctime }" pattern="yyyy-MM-dd HH:mm:ss"/></p>
                                        </div>
                                    </div>
                                </div>
								</c:forEach>
	                        ...
	                        <div class="text-center">
	                            <nav>
	                                <ul class="pagination"> 
	                                    <li <c:if test="${requestScope.pagebean.isfirst}">class="disabled"</c:if> ><a href="<c:url value='/user.action!tosignupcheck?pageindex=${requestScope.pagebean.preindex }&tg=${tg }'/>" aria-label="Previous"><i class="fa fa-angle-left"></i></a></li>
	                                    <c:forEach items="${requestScope.pagebean.pageList }" var="page"> 
	                                    	<li <c:if test="${requestScope.pagebean.pageindex eq page}">class="active"</c:if>><a href="<c:url value='/user.action!tosignupcheck?pageindex=${page }&tg=${tg }'/>">${page }</a></li>
	                                    </c:forEach>
	                                    <li <c:if test="${requestScope.pagebean.islast}">class="disabled"</c:if>><a href="<c:url value='/user.action!tosignupcheck?pageindex=${requestScope.pagebean.nextindex }&tg=${tg }'/>" aria-label="Next"><i class="fa fa-angle-right"></i></a></li>
	                                </ul>
	                            </nav>
	                        </div>
	                        </c:otherwise>
