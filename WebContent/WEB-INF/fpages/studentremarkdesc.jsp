                ...
                <div class="compose-right widget-shadow">
                    <div class="panel-default">
                        <div class="panel-heading">
                        	任务:${requestScope.taskfinish.task.name } 
                        	评价人:
                        	<c:choose>
                        		<c:when test="${not empty requestScope.taskfinish.userByRemarkuserId }">${requestScope.taskfinish.userByRemarkuserId.name}</c:when>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="com-mail" action="<c:url value='/task.action!remarktf'/>" method="post">
                                <textarea rows="6" name="remark" class="form-control1 control2" placeholder="评价内容:" readonly="readonly">${taskfinish.remark }</textarea>
                            </form>
                        </div>
                    </div>
                </div>
