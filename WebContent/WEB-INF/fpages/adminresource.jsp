        ...
        <div class="main-page">
            <div class="grids">
                <div class="panel panel-widget">
                    <a href="<c:url value='/resource.action!toadd'/>" class="hvr-icon-wobble-vertical">新增权限</a>
                    <div class="tables">
                        ...
                        <table class="table">
                            ...
                            <tr class="success">
                                ...
                                <td>${res.method }</td>
                                <td>${res.role.name }</td>
                                <td><a href="<c:url value='/resource.action!delete?res_id=${res.pk_id }'/>">删除</a></td>
                            </tr>
                            </c:forEach>
					...
					<c:choose>
	                        ...
	                        <div class="text-center">
	                            <nav>
	                                <ul class="pagination"> 
	                                    <li <c:if test="${requestScope.pagebean.isfirst}">class="disabled"</c:if> ><a href="<c:url value='/resource.action!toresource?pageindex=${requestScope.pagebean.preindex }'/>" aria-label="Previous"><i class="fa fa-angle-left"></i></a></li>
	                                    <c:forEach items="${requestScope.pagebean.pageList }" var="page"> 
	                                    	<li <c:if test="${requestScope.pagebean.pageindex eq page}">class="active"</c:if>><a href="<c:url value='/resource.action!toresource?pageindex=${page }'/>">${page }</a></li>
	                                    </c:forEach>
	                                    <li <c:if test="${requestScope.pagebean.islast}">class="disabled"</c:if>><a href="<c:url value='/resource.action!toresource?pageindex=${requestScope.pagebean.nextindex }'/>" aria-label="Next"><i class="fa fa-angle-right"></i></a></li>
	                                </ul>
	                            </nav>
	                        </div>
	                        </c:otherwise>
