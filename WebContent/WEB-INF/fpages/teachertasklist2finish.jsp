                ...
                <div class="panel panel-widget">
                    <div class="inbox-page">
                        ...
                        <div class="inbox-row widget-shadow"  role="tablist" aria-multiselectable="true">
                            ...
                            <a role="button"  href="<c:url value='/task.action!totaskfinish?task_id=${task.pk_id }'/>" >
                            ...
                            <div class="mail-right">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu float-right">
                                        <li>
                                            <a href="<c:url value='/task.action!totaskfinish?task_id=${task.pk_id }'/>" title="">
                        ...
                        <c:choose>
	                        ...
	                        <div class="text-center">
	                            <nav>
	                                <ul class="pagination"> 
	                                    <li <c:if test="${requestScope.pagebean.isfirst}">class="disabled"</c:if> ><a href="<c:url value='/task.action!tolist2finish?pageindex=${requestScope.pagebean.preindex }'/>" aria-label="Previous"><i class="fa fa-angle-left"></i></a></li>
	                                    <c:forEach items="${requestScope.pagebean.pageList }" var="page"> 
	                                    	<li <c:if test="${requestScope.pagebean.pageindex eq page}">class="active"</c:if>><a href="<c:url value='/task.action!tolist2finish?pageindex=${page }'/>">${page }</a></li>
	                                    </c:forEach>
	                                    <li <c:if test="${requestScope.pagebean.islast}">class="disabled"</c:if>><a href="<c:url value='/task.action!tolist2finish?pageindex=${requestScope.pagebean.nextindex }'/>" aria-label="Next"><i class="fa fa-angle-right"></i></a></li>
	                                </ul>
	                            </nav>
	                        </div>
	                        </c:otherwise>
