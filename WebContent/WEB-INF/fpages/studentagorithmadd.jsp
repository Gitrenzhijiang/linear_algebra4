                    ...
                    <div class="compose-right widget-shadow">
                        <div class="panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="com-mail" action="<c:url value='/agorithm.action!add'/>" enctype="multipart/form-data" method="post">
                                    <input type="text" class="form-control1 control3" placeholder="算法名称:" name="name" required>

                                    <div class="form-group">
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> java文件
                                            <input type="file" name="filepath" accept=".java" required>
                                        </div>
