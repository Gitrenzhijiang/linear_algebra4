                    ...
                    <div class="panel panel-widget">
                        <div class="validation-grids widget-shadow" data-example-id="basic-forms">
                            ...
                            <div class="form-body form-body-info">
                                <form data-toggle="validator" novalidate="true" action="<c:url value='/user.action!update'/>" method="post">
                                    <div class="form-group has-feedback">
                                        <input name="name" value="${requestScope.user.name }" type="text" class="form-control" id="inputName" placeholder="姓名" required="">
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                        <span class="help-block with-errors">${requestScope.name_err}</span>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input name="email" value="${requestScope.user.email }" type="email" class="form-control" id="inputEmail" placeholder="邮箱" data-error="Bruh, that email address is invalid" required="">
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                        <span class="help-block with-errors">${requestScope.email_err }</span>
                                    </div>


                                    <div class="form-group">
                                        <input name="password" value="${requestScope.user.password }" type="password" data-toggle="validator" data-minlength="1" class="form-control" id="inputPassword" placeholder="密码" required="">
                                    </div>
                                    <div class="form-group">
                                        <input name="repassword" value="${requestScope.user.password }" type="password" class="form-control" id="inputPasswordConfirm" data-match="#inputPassword" data-match-error="Whoops, these don't match" placeholder="确认密码" required="">
                                        <div class="help-block with-errors ">${requestScope.password_err }</div>
                                    </div>
									<div class="form-group">
											<select name="headpic"  class="form-control1">
												<option value="images/i3.png" >默认样式</option>
												<option value="images/i2.png" >样式1</option>
												<option value="images/i1.png">样式2</option>
												<option  value="images/i4.png">样式3</option>
											</select>
									</div>
                                    <label for="field-4-2" >Individual Resume:(maxlength: 300)</label>
                                    <div class="form-group" >
                                        <textarea name="descript" id="field-4-2"  maxlength="300" class="form-control" >${requestScope.user.descript }</textarea>
                                        <div class="help-block with-errors ">${requestScope.descript_err }</div>
                                    </div>
