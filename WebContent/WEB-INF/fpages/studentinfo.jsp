                ...
                <div class="panel panel-widget">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-2" >
                            <div class="well ">学号</div>
                        </div>
                        <div class="col-md-6">
                           <div class="well">
                               ${sessionScope.user.user_no }
                           </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2 col-md-offset-2" >
                            <div class="well ">姓名</div>
                        </div>
                        <div class="col-md-6">
                            <div class="well">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-2" >
                            <div class="well ">简介</div>
                        </div>
                        <div class="col-md-6">
                            <div class="well">
                            <c:choose>
                            	<c:when test="${empty sessionScope.user.descript }"> 这个人很懒，什么也没有留下！</c:when>
                            	<c:otherwise>
                            		${sessionScope.user.descript }
                            	</c:otherwise>
                            </c:choose>
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-2" >
                            <div class="well ">权限</div>
                        </div>
                        <div class="col-md-6">
                            <div class="well">
                            	${sessionScope.user.role.descript }
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-offset-8">
                            <a href="<c:url value='/user.action!toupdate'/>" class="hvr-icon-forward">更新个人信息</a>
                        </div>
                    </div>
                </div>
            </div>
