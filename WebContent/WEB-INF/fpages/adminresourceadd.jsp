                        ...
                        <div class="panel-default">
                            ...
                            <div class="panel-body">
                                <div class="alert alert-info">
                                    <c:if test="${not empty requestScope.form_err }">${requestScope.form_err }</c:if>
                                </div>
                                <form class="com-mail" action="<c:url value='/resource.action!add'/>" method="post">
                                    <input type="text" name="url" class="form-control1 control3" placeholder="url" required>
                                    <input type="text" name="method" class="form-control1 control3" placeholder="method">

                                    <div class="row">
                                        <div class="form-group">
                                            <label for="selector1" class="col-md-offset-1 col-md-2 well ">角色</label>
                                            <div class="col-md-8">
                                                <select name="role_id" id="selector1" class="form-control1">
                                                    <c:forEach items="${requestScope.roleList }" var="role">
                                                    	<option value="${role.pk_id }">${role.name }</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
