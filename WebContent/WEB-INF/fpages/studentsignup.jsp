...
<body class="login-bg">
		<div class="login-body">
			...
			<div class="login-info">
				<form action="<c:url value='/user.action!sturegist'/>" method="post">
					<input type="text" class="user" name="user_no" value="${requestScope.user_no }" placeholder="学号" required="">
					...
					<div class="text-center" style="color: red;">
						${requestScope.user_no_err}
						${requestScope.name_err}
						${requestScope.email_err}
						${requestScope.password_err}
					</div>
		...
		<div class="go-back login-go-back">
				<a href="<c:url value='/user.action!toteachersignup'/>">教师注册</a>
			</div>
