                        ...
                        <div class="panel-body">
                            <div class="alert alert-info">
                                	<c:choose>
                                		...
                                		<c:otherwise>请详细填写问题内容</c:otherwise>
                                	</c:choose>
                            </div>
                            <form class="com-mail" action="<c:url value='/question.action!ask'/>" method="post" enctype="multipart/form-data">
                                <input type="text" name="title" class="form-control1 control3" placeholder="问题标题:" required>

                                <textarea rows="6" name="descript" class="form-control1 control2" placeholder="问题描述:" required></textarea>
                                <div class="form-group">
                                    <div class="btn btn-default btn-file">
                                        <i class="fa fa-paperclip"></i>
                                        <input type="file" name="qpicpath" accept=".jpg,.png,.bmp,.jpeg,.gif">图片(可选)
                                    </div>
