                        ...
                        <div class="panel-body">
                            <div class="alert alert-info">
                                	<c:choose>
                                		...
                                		<c:otherwise>请认真填写下列内容</c:otherwise>
                                	</c:choose>
                            </div>
                            <form class="com-mail" action="<c:url value='/tres.action!upload'/>" method="post" enctype="multipart/form-data">
                                <input type="text" name="rname" value="${requestScope.teachresource.rname }" class="form-control1 control3" placeholder="资料名称:" required>

                                <textarea rows="6" name="descript" class="form-control1 control2" placeholder="资料描述:" required>${requestScope.teachresource.descript }</textarea>
                                <div class="form-group">
                                    <div class="btn btn-default btn-file">
                                        <i class="fa fa-paperclip"></i>
                                        <input type="file" name="rfilepath" required>资料
                                    </div>
