                        ...
                        <div class="panel-body">
                            <div class="alert alert-info">
                            	<c:choose>
                            		...
                            		<c:otherwise>请详细填写作业要求</c:otherwise>
                            	</c:choose>
                            </div>
                            <form class="com-mail" action="<c:url value='/task.action!add'/>" method="post" enctype="multipart/form-data">
                                <input type="text" name="name" value="${requestScope.task.name }" class="form-control1 control3" placeholder="作业名称:" required>

                                <textarea name="descript" rows="6" class="form-control1 control2" placeholder="作业描述:" required>${requestScope.task.descript }</textarea>
                                <div class="form-group">
                                    <div class="btn btn-default btn-file">
                                        <i class="fa fa-paperclip"></i>
                                        <input type="file" name="name">作业附件
                                    </div>
