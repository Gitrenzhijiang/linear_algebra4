        ...
        <div class="main-page">
            <div class="grids">
                ...
                <div class="panel panel-widget">
                    <a href="<c:url value='/task.action!tomytask'/>" class="hvr-icon-back">返回我的作业</a>
                    <div class="grid_3 grid_5">

                        <div class="but_list">
                            <div class="well">
                                作业名称:${requestScope.task.name }
                            </div>

                            <div class="well">
                                作业描述:${requestScope.task.descript }

                            </div>

                            <div class="well">
                                作业发布者:${requestScope.task.user.name }
                            </div>
                            <div class="well">
                                作业发布时间:<fmt:formatDate value="${requestScope.task.createtime }" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </div>
                            <div>
								<c:if test="${not empty requestScope.task.filepath}">
                                	<a href="<c:url value='/task.action!download?task_id=${requestScope.task.pk_id }'/>" class="hvr-icon-down">下载作业附件</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
