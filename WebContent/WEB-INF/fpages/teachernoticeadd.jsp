                        ...
                        <div class="panel-body">
                            <div class="alert alert-info">
                                <c:choose>
                                	...
                                	<c:otherwise> 请详细填写通知内容</c:otherwise>
                                </c:choose>
                            </div>
                            <form class="com-mail" action="<c:url value='/notice.action!addnotice'/>" method="post">
                                <input type="text" name="ntitle"  value="${notice.ntitle }" class="form-control1 control3" placeholder="通知标题:" required>

                                <textarea rows="6" name="ntext" class="form-control1 control2" placeholder="通知内容:" required>${notice.ntext }</textarea>
