        ...
        <div class="main-page">
            <div class="grids">
                <div class="panel panel-widget">
                    <a href="<c:url value='/agorithm.action!toadd'/>" class="hvr-icon-wobble-vertical">上传算法</a>
                    <div class="tables">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                            	...
                            	<c:forEach items="${requestScope.agoList }" var="ago" varStatus="i">
	                                <tr 
                            				<c:if test="${i.index % 2 eq 0}">class="success"</c:if>
	                                >
	                                    <th scope="row">${ago.pk_id }</th>
	                                    <td>${ago.name }</td>
	                                    <td><a href="<c:url value='/agorithm.action!download?agorithm_id=${ago.pk_id }'/>">下载</a></td>
	                                    <td>
	                                        <a href="<c:url value='/agorithm.action!toagodesc?agorithm_id=${ago.pk_id }&charset=gbk'/>">查看</a>
	                                        <a href="<c:url value='/agorithm.action!delete?agorithm_id=${ago.pk_id }'/>">删除</a>
	                                    </td>
	                                </tr>
                                </c:forEach>
                    ...
                    <c:choose>
	                        ...
	                        <div class="text-center">
	                            <nav>
	                                <ul class="pagination"> 
	                                    <li <c:if test="${requestScope.pagebean.isfirst}">class="disabled"</c:if> ><a href="<c:url value='/agorithm.action!tomyago?pageindex=${requestScope.pagebean.preindex }'/>" aria-label="Previous"><i class="fa fa-angle-left"></i></a></li>
	                                    <c:forEach items="${requestScope.pagebean.pageList }" var="page"> 
	                                    	<li <c:if test="${requestScope.pagebean.pageindex eq page}">class="active"</c:if>><a href="<c:url value='/agorithm.action!tomyago?pageindex=${page }'/>">${page }</a></li>
	                                    </c:forEach>
	                                    <li <c:if test="${requestScope.pagebean.islast}">class="disabled"</c:if>><a href="<c:url value='/agorithm.action!tomyago?pageindex=${requestScope.pagebean.nextindex }'/>" aria-label="Next"><i class="fa fa-angle-right"></i></a></li>
	                                </ul>
	                            </nav>
	                        </div>
	                        </c:otherwise>
