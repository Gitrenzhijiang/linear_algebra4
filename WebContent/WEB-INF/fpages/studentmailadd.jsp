                        ...
                        <div class="panel-default">
                            ...
                            <div class="panel-body">
                                <div class="alert alert-info">
									${requestScope.form_err }
                                </div>
                                <form class="com-mail" action="<c:url value='/mail.action!add'/>" method="post">
                                    <input type="text" name="user_no" value="${requestScope.user_no }" class="form-control1 control3" placeholder="To 学号/职工号:" required>
                                    <input type="text" name="subject" value="${requestScope.inbox.subject }" class="form-control1 control3" placeholder="主题:" required>
                                    <textarea rows="6" name="message" class="form-control1 control2" placeholder="内容:" required>${inbox.message }</textarea>
